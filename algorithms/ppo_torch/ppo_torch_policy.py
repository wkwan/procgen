...
class PPOLoss:
    def __init__(self,
        ...
        print("value targets", value_targets.shape, value_targets)
        ...
        self.loss = torch.stack((-entropy_coeff * curr_entropy + self.mean_policy_loss + cur_kl_coeff * action_kl, vf_loss_coeff * self.mean_vf_loss))
